...
namespace CateringLarissa2.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var review = await _context.Review.FindAsync(id);
#pragma warning disable CS8604 // Possible null reference argument for parameter 'entity' in 'EntityEntry<Review> DbSet<Review>.Remove(Review entity)'.
            _context.Review.Remove(review);
#pragma warning restore CS8604 // Possible null reference argument for parameter 'entity' in 'EntityEntry<Review> DbSet<Review>.Remove(Review entity)'.
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
